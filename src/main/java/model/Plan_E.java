 ...
 * @author eljos
 */
public class Plan_E extends PlanEstudio{
    public Plan_E(Carrera carrera, char tipo) {
        super(carrera, tipo);
        this.setDescripcion("Aprobar todos los Finales de las Materias Correlativas y los Finales de los 3 Cuatrimestres Previos");
    }
    ...
    public boolean verificarPlan(Alumno alumno, Materia materia) {
        ...
        if(materia.correlativas.size()>0){
           condicion1 = materia.verificarCorrelativasAprobadas(alumno);
        }
        else {
            condicion1 = true;
        }
